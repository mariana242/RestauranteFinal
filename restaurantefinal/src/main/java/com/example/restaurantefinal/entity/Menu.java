...
public class Menu {
    ...
    public Menu(Long id, Character rol, String nombrePlato, Integer precio, String descripcion, String url, String categoria, Boolean estado, String sede, Double tiempoPreparacion) {
        this.id = id;
        this.rol = rol;
